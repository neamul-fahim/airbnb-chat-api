...
from mongodb_connection import get_data, overwrite_data, overwrite_data, app
from ML_chat_bot import find_ans, reload_ans_corpus_file
from check_ans import is_ans
from is_question import is_ques

# to get all the question answer form mongodb set by the user to view and edit


@app.route("/ans_corpus_get", methods=["GET"])
def ans_corpus_get():
    ans_corpus = get_data()
...
@app.route("/ans_corpus_post", methods=["POST"])
def ans_corpus_post():
